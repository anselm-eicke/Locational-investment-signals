...
instr_const(tec,n)..            INSTRUMENT('wind','south') =e= 0;
...
Display GEN.L, CAP.L, network_cost, GRID_CAP.L, i_instrument;

execute_UNLOAD 'Output/with_locational_instrument.gdx' generation_costs, network_cost, res_share, o_cap, o_gen, c_fix;