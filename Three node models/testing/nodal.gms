...
Display GEN.L, CAP.L, price, load_deviation, network_cost, consumer_surplus, generation_costs, GRID_CAP.L;

execute_UNLOAD 'Output/nodal.gdx' consumer_surplus, generation_costs, network_cost, o_gen, price, c_fix;
