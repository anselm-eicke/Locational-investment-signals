...
KKT_load(t,n)..         -p_ref * ((1-1/elasticity) + LOAD_real(t,n) / (elasticity * load_ref(t,n))) - mu_D_min(t,n) + LAMBDA(t) =e= 0;                
...
o_price(t,n) = p_ref * (1 - 1/elasticity + (LOAD_real.L(t,n)/ load_ref(t,n) / elasticity));
