...
i_instrument = INSTRUMENT.L / sc / 1000;
...
execute_UNLOAD 'Output/without_instrument_test.gdx' consumer_surplus, generation_costs, network_cost, res_share, i_instrument, o_cap, o_gen, price, c_fix;