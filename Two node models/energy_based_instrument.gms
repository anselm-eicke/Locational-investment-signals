...
KKT_GEN(t,tec,n)..              c_var(tec,n) + INSTRUMENT(tec,n) + mu_G_max(t,tec,n) - mu_G_min(t,tec,n) - SPOT_PRICE(t) =e= 0;
...
execute_UNLOAD 'Output/energy_based_instrument.gdx' welfare, consumer_surplus, generation_costs, network_cost, network_cost_1, network_cost_2, network_cost_3, res_share, o_instrument, sum_instrument, o_cap, o_gen, price, c_fix;