...
energy_balance, tie_break_eq
KKT_GEN_1, KKT_CAP_1, KKT_load, KKT_tie;
...
tie_break_eq(t,tec,n)..     0 =e= CAP(tec,n) * SHARE(t,tec) - GEN(t,tec,n);
             
*KKT conditions
KKT_GEN_1(t,tec,n)..          c_var(tec,n) + mu_G_max(t,tec,n) - mu_G_min(t,tec,n) - LAMBDA(t) - RHO(t,tec,n) =e= 0;
KKT_CAP_1(tec,n)..            c_fix(tec,n) + 2 * supply_slope * CAP(tec,n) + INSTRUMENT(tec,n) - sum(t,avail(t,tec,n) * mu_G_max(t,tec,n)) + mu_C_max(tec,n) - mu_C_min(tec,n) + sum(t,RHO(t,tec,n) * SHARE(t,tec)) =e= 0;
KKT_load(t,n)..             -p_ref * ((1-1/elasticity) + LOAD_real(t,n) / (elasticity * load(t,n))) - mu_D_min(t,n) + LAMBDA(t) =e= 0;                
KKT_tie(t,con,n)..          RHO(t,con,n) * CAP(con,n) =e= 0;
...
Display GEN.L, CAP.L, LOAD_real.L, LAMBDA.L, o_price, load_deviation;
