...
cap_min(tec,n)..            CAP(tec,n) =g= 0;
cap_max(tec,n)..            0 =g= CAP(tec,n) - cap_lim(tec,n);
               
*KKT conditions
KKT_GEN(t,tec,n)..          c_var(tec,n) + 0.002 * GEN(t,tec,n) - p_ref * (1-(1/elasticity)) - p_ref * sum((ttec, nn), GEN(t,ttec,nn)) / (elasticity * sum(nn, load(t,nn))) + mu_G_max(t,tec,n) - mu_G_min(t,tec,n) =e= 0;
